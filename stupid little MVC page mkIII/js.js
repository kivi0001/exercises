...
const modelHentetFraLS = JSON.parse(localStorage.getItem("stupid_array"));
console.log("modelHentetFraLS", modelHentetFraLS);
//Model
const model = modelHentetFraLS ?? ["Peter", "Paul", "Mary"];
// controller
init();
